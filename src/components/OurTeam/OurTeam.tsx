  ...
  return (
    ...
    >
      <div className="container">
        <h3 className="our-team__title" data-aos="fade-up" data-aos-duration="2000">
          Our top team
        </h3>
        ...
        <div className="our-team__block-main team-main-block">
          <h2 className='team-main-block__title' data-aos="fade-up" data-aos-duration="2000">
            The scale of the challenges facing our planet can seem daunting, but we can all do something.
          </h2>

          <ul className='team-main-block__list' data-aos="fade-up" data-aos-duration="2000">
